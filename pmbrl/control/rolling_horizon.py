'''
11/05/2020
RHE created to plan in discrete action spaces for the Expected Free Energy
...
class RollingHorizon():
    ...
    def select_action(self, state):
        ...
        for _ in range(self.optim_iters):
            ...
            if best_return <= lowest_return:
                lowest_return = best_return
        ...
        return overall_best_rollout[0], lowest_return
    ...
    def evaluate_sequences(self, init_state, action_seqs):
        ...
        best_return, idx_best = returns.min(dim=0)
