...
def main(args):
    ...
    tbWriter = SummaryWriter('tensorboard/Pixelcopter-SMIRL-FEP-{}'.format(time_stamp), comment='FEP RHE')
    ...
    for episode in range(1, args.n_episodes):
        ...
        tbWriter.add_scalar('data/instrumental', r_smirl, episode)
        ...
        wandb.log({"Instrumental": r_smirl, "Episode": episode})
